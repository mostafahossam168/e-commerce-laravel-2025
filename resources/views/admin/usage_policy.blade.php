...
@section('content')
    <div class="main-side">
        ...
        <div class="row g-4">
            ...
            <form action="{{ route('admin.usage-policy.update', 'test') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row row-gap-24">
                    <div class="col-12 col-md-6">
                        ...
                        <textarea name="usage_policy" required class="ckeditor form-control">{!! setting('usage_policy') !!}</textarea>
                    </div>
